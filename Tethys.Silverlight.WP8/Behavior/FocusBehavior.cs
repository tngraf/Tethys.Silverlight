...
namespace Tethys.Silverlight.Behavior
{
     ...
     * 
     * => The focus will only get set, when the content of the textbox is changed.
     * When the textbox is empty or the contents of the textbox is set by the view model
     * constructor the textbox is NOT focused!
     */
