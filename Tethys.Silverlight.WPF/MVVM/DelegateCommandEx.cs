...
// ===========================================================================
//
// <copyright file="DelegateCommandEx.cs" company="Tethys">
...
namespace Tethys.Silverlight.MVVM
{
    ...
    /// </remarks>
    public class DelegateCommandEx : ICommand
    {
        #region EVENTS
        /// <summary>
        ...
        #region CONSTRUCTORS
        /// <summary>
        /// Initializes a new instance of the <see cref="DelegateCommandEx"/> class.
        /// </summary>
        /// <param name="execute">The execute.</param>
        public DelegateCommandEx(Action<object> execute)
            : this(execute, null)
        {
        } // DelegateCommandEx()
        ...
        public DelegateCommandEx(Action<object> execute, Predicate<object> canExecute)
        {
