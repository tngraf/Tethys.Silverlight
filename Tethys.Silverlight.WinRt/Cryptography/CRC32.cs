...
namespace Tethys.Silverlight.Cryptography
{
  ...
  public sealed class CRC32
  {
    ...
    ----  "C Programmer's Guide to NetBIOS" Howard W. Sams & Company
          ...
          by Marcellus Buchheit after the guidelines of the CRC-CCITT algorithm
          in the book above.
    ...
    *****************************************************************************/
    ...
    /// Hash algorithm name.
    /// </summary>
    private const string AlgorithmNameCrc32 = "CRC32";
    ...
    public byte[] HashData(IBuffer data)
    {
      ...
      for (int o = 0; o < data.Length; o++)
      {
        ...
        uint i = (byte)(this.crc ^ stream.ReadByte());
